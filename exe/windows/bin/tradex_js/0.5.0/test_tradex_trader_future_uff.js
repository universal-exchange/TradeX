...
class deploy_future_uff {
    constructor() {
        ...
        this.port = 8021
        this.trader = 'tradex_trade_future_uff'
    }
}
...
async function Test_TradeX_Trader_Future_UFF() {
    let kernel = new cyberx.Kernel(new syscfg.SysCfg()) // 全局唯一
    let module = new cyberx.Create('tradex_trader_future_uff') // 全局唯一
    //let module_01 = new cyberx.Create('tradex_trader_future_uff') // 重复创建会报异常
    //let module_01 = new cyberx.GetCreate('tradex_trader_future_uff') // 可以获取已创建的实例
