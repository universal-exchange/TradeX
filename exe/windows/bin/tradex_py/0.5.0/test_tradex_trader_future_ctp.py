...
class deploy_future_ctp(object):
    def __init__(self):
        ...
        self.port = 8021
        self.trader = "tradex_trader_future_ctp"
...
def Test_TradeX_Trader_Future_CTP():
    global g_order
    global g_session
    global g_strategy
    global g_caller_wait_time
    ...
    module = cyberx.Create("tradex_trader_future_ctp") # 全局唯一
    #module_01 = cyberx.Create("tradex_trader_future_ctp") # 重复创建会报异常
    #module_01 = cyberx.GetCreate("tradex_trader_future_ctp") # 可以获取已创建的实例
